...
// Write File struct to yml file
func (f *File) WriteToFile(filePath string) error {
	y, err := f.Marshal()
	if err != nil {
		fmt.Println("Marshal yaml failed")
		return err
	}
	yml := string(y)
	...
	_, _ = sysfile.WriteString("# Auto-generated by DDBT at " + time.Now().String() + "\n")
	_, err = sysfile.WriteString(yml)
	if err != nil {
		return err
	}
	return nil
